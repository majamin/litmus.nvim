...
function M.setup()
  ...
  Group.new("Search", c.litmus_9, c.info)
  ...
  Group.new("StorageClass", c.litmus_2, nil, s.bold)
  ...
  Group.new("csvCol0", c.error, nil, nil)
  Group.new("csvCol1", c.warning, nil, nil)
  Group.new("csvCol2", c.info, nil, nil)
  Group.new("csvCol3", c.hint, nil, nil)
  Group.new("csvCol4", c.add, nil, nil)
  Group.new("csvCol5", c.change, nil, nil)
  Group.new("csvCol6", c.delete, nil, nil)
  Group.new("csvCol6", c.error, nil, nil)
  Group.new("csvCol7", c.warning, nil, nil)
  Group.new("csvCol8", c.info, nil, nil)
  Group.new("csvCol9", c.hint, nil, nil)
  Group.new("csvCol10", c.add, nil, nil)
  Group.new("csvCol11", c.change, nil, nil)
  Group.new("csvCol12", c.delete, nil, nil)
